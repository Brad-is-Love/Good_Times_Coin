...
function Navtwo(props) {
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="/home">GTC</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="https://drive.google.com/file/d/1mGGZ02D6ULzOyikbOTPXzgC7BgJXjwBm/view?usp=sharing">Whitepaper</a>
        </li>
        <li class="nav-item">
