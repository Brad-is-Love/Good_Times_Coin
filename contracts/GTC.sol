...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor (string memory name_, string memory symbol_, uint8 decimal_, address owner_, uint256 initialSupply_, uint256 totalSupply_) {
        _name = name_;
        _symbol = symbol_;
        _decimal = decimal_;
        _owner = owner_;
    ...
    /**
     * @dev Returns initial supply when token was created.
     */
     ...
     *
     */
    function circSupply() public view virtual returns (uint256) {
        return _circSupply;
    }
    ...
    function burn(address account, uint256 amount) public virtual {
        require(msg.sender == _owner, "ERC20: Must be the owner to burn");
